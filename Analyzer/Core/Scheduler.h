...
namespace AVSAnalyzer {
	...
	public:
		...
		Algorithm* algorithm_onnx_yolo8 = nullptr;
		std::mutex algorithm_onnx_yolo8_mtx;
		Algorithm* algorithm_tr_yolo8 = nullptr;
		std::mutex algorithm_tr_yolo8_mtx;
		Algorithm* algorithm_ov_yolo8 = nullptr;
		std::mutex algorithm_ov_yolo8_mtx;
